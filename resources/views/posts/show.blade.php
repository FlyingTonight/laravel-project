            ...
            <div class="row">
                    ...
                    <div class="col-lg-8">
                        ...
                        @canany(['update', 'delete'], $post)
                            ...
                            <a href="{{ route('posts.edit',['post' => $post->id]) }}" class="btn btn-sm btn-outline-dark mr-2" >
                                O'zgaritish
                            </a>

                            <form action="{{ route('posts.destroy',['post'=>$post->id])}}" method="POST"
                                onsubmit="return confirm('Rostanham ochirishni hohlaysizmi?');"
                                >
                                @csrf
                                @method('DELETE')
                      ...
                      @endcanany
                        ...
                        <div class="d-flex mb-2">
                            <a class="text-white text-uppercase font-weight-medium px-2 py-1 bg-secondary rounded" href="">{{$post->category->name}}</a>
                        </div>
                    ...
                    <div class="mb-5">
                        ...
                        <div class="d-flex align-items-center border-bottom mb-3 pb-3">
                            ...
                            <div class="d-flex flex-column pl-3">
                                <a class="text-dark mb-2" href="">{{$post->content}}</a>
                                <div class="d-flex">
